...
class BTWindow(xdot.DotWindow):
    ...
    def get_dot_for_node(self, node):
        ...
        if type == 'Sequence':
            dotcode += """[label=\"->\" penwidth=\"6\"  shape=\"box\" color=\"""" + nodeColor + """\" ]; \n """
        elif type == 'Selector':
            dotcode += """[label=\"?\" penwidth=\"6\"  shape=\"box\" color=\" """ + nodeColor + """\" ]; \n """
        elif type == 'Action':
            dotcode += "[label= """ + node.name + """ penwidth=\"6\"  shape=\"box\" color=\"""" + nodeColor + """\"  ];\n """
        elif type == 'Condition':
            dotcode += "[label=""" + node.name + """ penwidth=\"6\"  shape=\"ellipse\" color=\"""" + nodeColor + """\" ]; \n"""
        else:
